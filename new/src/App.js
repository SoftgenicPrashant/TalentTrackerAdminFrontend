...
import Listofjds from "./Components/Listofjds/Listofjds";
import Userinformation from "./Components/Userinformation/Userinformation";
import Filterlistofjds from "./Components/Listofjds/Filterlistofjds";
import FilterClientmaster from "./Components/Client/FilterClientmaster";
import FilterInvoice from "./Components/Invoicing/FilterInvoice";
import EditListOfCandidate from "./Components/ListOfCandi/EditListOfCandidate";
...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/editmaster" element={<EditClientmaster/>}/>
      <Route path="/jd-template" element={<TemplateList/>}/>
      <Route path="/edit-template" element={<EditTemplate/>}/>
      <Route path="/listofjds" element={<Listofjds/>}/>
      <Route path="/report-edit" element={<Editreport/>}/>
      <Route path="/user-information" element={<Userinformation/>}/>
      <Route path="/JdListFilter" element={<Filterlistofjds/>}/>
      <Route path="/filter-Client-Master" element={<FilterClientmaster/>}/>
      <Route path="/filter-invoice" element={<FilterInvoice/>}/>
      <Route path="/Edit-List-of-candidate" element={<EditListOfCandidate/>}/>
    </Routes>
  </BrowserRouter>
    </>
  );

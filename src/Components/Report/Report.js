  ...
  return (
    <div>
        ...
        <Container className='myprofile'>
          ...
          <ButtonGroup>
            <Button variant='success' as={Link} to='/report-filter' style={{marginLeft:'4px'}}><i className="fa fa-filter me-2" style={{color:'#fff'}} ></i>Filter</Button>
        ...
        <Table responsive  className='data-table' hover>
            ...
            <tbody>
                ...
                <td><Form.Check type='checkbox'></Form.Check></td>
                    ...
                    <td>na</td>
                    <td>na</td>
                               <td><Button variant='success' as={Link} to='/report-edit' style={{marginLeft:'4px'}} ><i className="fa fa-edit me-2" style={{color:'#fff'}} ></i>Edit</Button>
</td>
                   </tr>
                   <tr>
                <td><Form.Check type='checkbox'></Form.Check></td>

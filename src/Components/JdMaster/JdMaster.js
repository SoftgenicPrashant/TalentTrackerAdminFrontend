...
const headers = [
    ...
    {label:"Force to use our ?", key:"Candidatename"},
        ...
        <Table responsive className='data-table' hover >
            <thead>
                ...
                <th>Company</th>
                            ...
                            <th>Category of user who accepted the JD</th>
                            <th>Force to use Talent Tracker's database? </th>
                            <th>Force to use  Own database? </th>
                            <th>User has choosen to use which database?(own/Talent Tracker's database) </th>
                            <th>Client Spoc mobile number to be disclosed to user for this JD?</th>
                            <th>Exclusivity</th>
            ...
            <tbody>
              {/* {getdata.map((jd)=>{
               ...
               <td><Form.Check type='checkbox'></Form.Check></td>
                    <td>clientId</td>
                    <td   className='position'>company_name<td className='absolute'> <span className='d-flex'> 
            ...
            <i className="fas fa-globe me-2" as={Link} to="'/www.talenttracker.com" ></i> | <i className="fab fa-linkedin ms-2 me-2" as={Link} to='/'></i> | <i className="fas fa-info-circle ms-2" onClick={handleShow4}></i>  </span></td></td>
                    <td>AssuredDeliveryReqByClient</td>
                    ...
                    <td>status</td>
                    <td>UserCategory</td>
                    <td >ourdatabaseUsed</td>
                    <td>na</td>
                    <td>na</td>
                    <td>yes</td>
                    <td>exclusivity</td>
                      <td>CVqualcheckreqbyAdmin</td>
                      <td>prioritytag</td>
                    ...
                    <td>clientEmailListTo</td>
                    <td>allowonecandidatesubmbyuser</td>
                    ...
                    <td></td>
                    <td><Button variant='primary' as={Link} to='/jd-template'><i className='fa fa-paper-plane'></i></Button></td>
                    <td  onClick={handleShow2} style={{color:'blue', textDecoration:'underline'}}><i className='fa fa-info-circle'></i></td>
                    <td>na</td>
                    <td>JDuploadDate</td>
                    <td>JDuploadtime</td>
                    
                    <td>mobiledisclosed</td>
      ...
      <Modal show={show4} onHide={handleClose4} size='xl'>
        ...
        <Modal.Body>
            ...
            <Col xs={4}>
               ...
               <Row>
                <Col xs={6}>
                <Form.Control type='text' name="" value="First name" />  
                </Col>
                <Col xs={6}>
                <Form.Control type='text' name="" value="Last name" />  
                </Col>
               </Row>

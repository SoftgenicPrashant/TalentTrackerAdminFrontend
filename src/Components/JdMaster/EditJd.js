...
const EditJd = () => {
  ...
  const handleselected10 = () => Setselected10(!selected10) 
   const [selected11, Setselected11]=useState(false)
  const handleselected11 = () => Setselected11(!selected11) 
    ...
    const option1= [
      ...
      { value: 'Virtual(Google meet,Zoom calls , Team Meeting, Skype etc)', label: 'Virtual(Google meet,Zoom calls , Team Meeting, Skype etc)' },
      { value: 'Face to Face', label: 'Face to Face' },
      { value: 'Management/Hr Round', label: 'Management/Hr Round' }
    ]
  return (
    <div>
      ...
      <Container className="jd-cont">
          ...
          <Row>
                ...
                <Form.Select aria-label="Default A example" name="">
                ...
                <Col xs={6}>
                <Form.Label  className='fw-bold mb-3 mt-3'>Force to use Talent Tracker's candidate Database?</Form.Label>
                <Form.Check type="checkbox" label="You must use our database etc for this JD " />
                
                </Col>
                  <Col xs={6}>
                <Form.Label  className='fw-bold mb-3 mt-3'>Force to use own database? (Naukri, Monster, Times jobs, Shine etc)
</Form.Label>
                <Form.Check type="checkbox" label="You must use our database etc for this JD " />
              ...
              <Row>
                ...
                <Form.Select aria-label="Default 1 example" name="">
                ...
                <Form.Select aria-label="Default  example" name="">
              ...
              <Row>
                ...
                <Form.Check type="checkbox" name="" label="Hot "  />
                </Col>
                <Col xs={6}>
                  <Row>
                    <Col xs={6}>
  ...
  <Dropdown.Menu>
    ...
    <Dropdown.Item  onClick={handleselected11} >Create</Dropdown.Item>
              ...
              <Row>
                ...
                <Form.Select aria-label="Default Immediate example" name="">
              ...
              <Row>
                  ...
                  <Form.Control type="text" name="" placeholder='Remarks'></Form.Control>
                  </Col>
                  </Row>
              <Row>
                <Col xs={6}>
  ...
  <Dropdown.Menu>
    ...
    <Dropdown.Item  onClick={handleselected8} >Create</Dropdown.Item>
                ...
                <Form.Select aria-label="Default yes example" name="">
            ...
            <Col xs={4}>
              ...
              <Row>
                ...
                <Form.Control type='text' name="" value='talenttracker'/>
                </Col>
              </Row>
              <Row>
                ...
                <Form.Select aria-label="Default select Company Size example" name="">
        ...
        <FormControl id="inlineFormInputGroup" placeholder=" Email"  name=""/>
      </InputGroup>
      </Col>
      <Col xs={6}>
      <InputGroup className="mb-2">
        ...
        <FormControl id="inlineFormInputGroup" placeholder=" Email"  name=""/>
                ...
                <Row>
                    ...
                    <Form.Select aria-label="Default user example" name="">
                    ...
                    <Form.Control type="date" name="" ></Form.Control>
                    </Col>
                </Row>
                <Row>
                    <Col xs={6}>
                    ...
                    <Form.Select aria-label="Default 30days example" name="">
                ...
                <Row>
                  <Col xs={6}>
                  <Form.Label className='fw-bold mb-3 mt-3'>Feedback From Client</Form.Label>
                  <Form.Control as="textarea" name="" placeholder='Client Feedback'></Form.Control>
                ...
                <Form.Select aria-label="Default 8.33% example" name="Agreed_signup_rate">
                    ...
                    <Button variant='primary' onClick={handleselected10} >Create</Button>
                ...
                <Row>
                  ...
                  <Form.Check type="radio" label="% payout If you use Talent Tracker’s database. " onClick={handleCheck} />
                  {checked? <div>
                  
                    <Form.Check type="radio" label=" If consultancy"  onClick={handleCheck4}/>
                    <Form.Check type="radio" label=" If Individual"  onClick={handleCheck5}/>
                  ...
                  {checked5? <div>
                    ...
                    <Form.Check type="radio" label=" % payout if you use your own portal- naukri/monster/times job etc " onClick={handleCheck1} />
                    {checked1? <div>
                      <Form.Check type="radio" label=" If consultancy"  onClick={handleCheck6}/>
                    <Form.Check type="radio" label=" If Individual"  onClick={handleCheck7}/>
                  ...
                  {checked7? <div>
                    ...
                    <Form.Check type="radio" label=" absolute value payout if use your own portal (Naukri/Monster/Timesjob etc) " onClick={handleCheck2} />
                    {checked2? <div>
                      <Form.Check type="radio" label=" If consultancy"  onClick={handleCheck8}/>
                    <Form.Check type="radio" label=" If Individual"  onClick={handleCheck9}/>
                  ...
                  {checked9? <div>
                    ...
                    <Form.Check type="radio" label=" absolute value payout---if use Talent Trackers database. " onClick={handleCheck3}/>
                    {checked3? <div>
                      <Form.Check type="radio" label=" If consultancy"  onClick={handleCheck10}/>
                    <Form.Check type="radio" label=" If Individual"  onClick={handleCheck11}/>
      ...
      <Modal show={show6} onHide={handleClose6} size='lg'>
        ...
        <Modal.Body>
          <Form>
            ...
            <Row>
            <Col xs={6}>
               <Form.Label className=''>Admin Spoc Designation</Form.Label>  
               <Form.Control type='text' name=""/>        
